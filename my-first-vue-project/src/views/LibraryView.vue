...
const { isPlaying, currentTrack, currentArtist } = storeToRefs(useBeat)

const playFunc = () => {
    if (currentTrack.value) {
        useBeat.playOrPauseThisBeat(currentArtist.value, currentTrack.value)
        return
    } 
    useBeat.playFromFirst()
}
</script>
            ...
            <div class="w-full ml-5">
                ...
                <div class="absolute flex gap-4 items-center justify-start bottom-0 mb-1.5">
                    <button class="p-1 rounded-full bg-white" @click="playFunc()">
                        <Play v-if="!isPlaying" fillColor="#181818" :size="20"/>
