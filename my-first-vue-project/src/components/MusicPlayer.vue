...
const { isPlaying, audio, currentTrack, currentArtist } = storeToRefs(useBeat)
...
watch(() => isTrackTimeCurrent.value, (time) => {
    if (time && time == isTrackTimeTotal.value) {
        useBeat.nextBeat(currentTrack.value)
    }
})
        ...
        <div class="max-w-[35%] mx-auto w-2/4 mb-3">
            <div class="flex-col items-center justify-center">
                <div class="buttons flex items-center justify-center h-[30px]">
                    <button class="mx-2">
                        <SkipBackward fillColor="#FFFFFF" :size="25" @click="useBeat.prevBeat(currentTrack)"/>
                    </button>
                    <button class="p-1 rounded-full mx-3 bg-white" @click="useBeat.playOrPauseThisBeat(currentArtist, currentTrack)">
                        <Play v-if="!isPlaying" fillColor="#181818" :size="25" />
                        <Pause v-else fillColor="#181818" :size="25" />
                    </button>
                    <button class="mx-2">
                        <SkipForward fillColor="#FFFFFF" :size="25" @click="useBeat.nextBeat(currentTrack)"/>
                    </button>
                </div>
