...
const useBeat = useBeatStore()
const { isPlaying, currentTrack} = storeToRefs(useBeat)
    ...
    justify-between">
      ...
      class="bg-black hover:bg-[#282828] rounded-full p-0.5 mr-8 mt-0.5 cursor-pointer">
        <div class="flex items-center">
          ...
          class="rounded-full"
          width = "27"
          src="https://yt3.ggpht.com/yti/ADpuP3M5cw31xGIbr1MoC_o7_xe5PURWc_va-QlGU2Mxwg=s88-c-k-c0x00ffffff-no-rj">
          <div class="text-white text-[14px] ml-1.5 font-semibold">Kay</div>
      ...
      <span v-if="openMenu"
                ...
                <ul class="text-gray-200 font-semibold text-[14px]">
                    <li class="px-3 py-2.5 hover:bg-[#3E3D3D] border-b border-b-gray-600">My Profile</li>
            ...
            <ul>
                ...
                <MenuItem class="-ml-[1px]" :iconSize="27" name="Liked Beats" iconString="liked" pageUrl="/liked" />
            </ul>
